...
\begin{document}
	\chapter{시놉시스와 시나리오 기본 정보}
		\input{./Unliving/기본_정보.tex}
	
	\chapter{등장인물들의 이야기(이야기꾼 공개용)}
		\input{./Unliving/등장인물_공개.tex}
	
	\chapter{서사의 이야기(이야기꾼 공개용)}
		\input{./Unliving/서사_공개.tex}
	...
	\chapter{시나리오의 흐름}
		\input{./Unliving/시나리오_흐름.tex}
	
	\chapter{서사의 이야기}
		\input{./Unliving/서사_진실.tex}
	
	\chapter{등장인물들의 진실된 이야기}
		\input{./Unliving/등장인물_진실.tex}
