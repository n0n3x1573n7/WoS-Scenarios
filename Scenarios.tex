...
\renewcommand{\hline}{\tabularnewline}
...
{ \ignorespaces \par
	\noindent
	\begin{tightcenter}
		\begin{tcolorbox}[standard jigsaw, opacityback=0, colframe=black!75!black, width=\linewidth, breakable=unlimited, tabular={|p{\widthratio\linewidth}|}, title={\large \centering \ifthenelse{\isempty{#1}}{\textbf{[#2]}}{\hypertarget{#1}{\textbf{[#2]}}}}]
		}
		{
		\end{tcolorbox}
	\end{tightcenter}
...
{ \ignorespaces \par
	\noindent
	\begin{tightcenter}
		\begin{tcolorbox}[standard jigsaw, opacityback=0, colframe=black!75!black, width=\linewidth, breakable, tabular={|p{\widthratio\linewidth}|}, title={\large \centering \ifthenelse{\isempty{#1}}{\textbf{[#2]}}{\hypertarget{#1}{\textbf{[#2]}}}}]
			\textbf{속성}: #3
			\\\hline
			\ignorespaces\unskip
		}
